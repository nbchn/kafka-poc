...
public class Subscriber implements MqttCallback {
    ...
    public void messageArrived(String topic, MqttMessage message) throws MqttException {
        ...
        try {
            ...
            final ProducerRecord<PositionKey, PositionValue> record = new ProducerRecord<>(
                    this.kafka_topic,
                    key,
                    value
            );
    ...
    private PositionValue getPositionValue(byte[] payload) throws IOException {
        ...
        return new PositionValue(
                vv.desi, vv.dir, vv.oper, vv.veh, vv.tst, vv.tsi, vv.spd, vv.hdg, vv.lat,
                vv.longitude, vv.acc, vv.dl, vv.odo, vv.drst, vv.oday, vv.jrn, vv.line,
                vv.start, vv.loc, vv.stop, vv.route, vv.occu, vv.seq
        );
    }
}
